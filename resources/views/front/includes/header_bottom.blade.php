                                ...
                                <ul class="menu level1">
                                    <li class="item  parent"><a href="#" title="Laptops &amp; Accessories"><i
                                        ...
                                        <div class="dropdown-menu" style="width:222px">
                                            <ul>
                                                <li class="item "><a href="#" title="Macbook Pro">Macbook Pro</a>
                                                </li>
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <ul>
                                                            <li class="item "><a href="#"
                                                                    title="Aliquam lobortis">Aliquam lobortis</a></li>
                                                            <li class="item "><a href="#"
                                                                    title="Duis Reprehenderit">Duis Reprehenderit</a>
                                                            </li>
                                                            <li class="item "><a href="#"
                                                            ...
                                                            <li class="item "><a href="#"
                                                                    title="Venison Andouille">Venison Andouille</a></li>
                                                        </ul>
                                                    </div>
                                                </li>
                                                <li class="item "><a href="#" title="EliteBook">EliteBook</a>
                                                </li>
                                                <li class="item "><a href="#" title="Lenovo Yoga">Lenovo Yoga</a>
                                                </li>
                                                ...
                                                <li class="item "><a href="#" title="Dell Alienware">Dell
                                                        Alienware</a></li>
                                                <li class="item "><a href="#" title="HP Pavilion">HP Pavilion</a>
                                                </li>
                                    ...
                                    <li class="item  parent group"><a href="#" title="Electronics"><i
                                            ...
                                            class="show-sub fa-active-sub"></span><span class="menu-sub-title">Blender ,
                                            iron, Vacuum cleaner ...</span>
                                                            ...
                                                            <div class="col-lg-3 col-12">
                                                                ...
                                                                <ul>
                                                                    <li class="item "><a href="#"
                                                                            ...
                                                                            Products</a></li>
                                                                    <li class="item  parent"><a href="#"
                                                                            title="UFi Products">UFi Products</a></li>
                                                                    <li class="item "><a href="#"
                                                                    ...
                                                                    <li class="item "><a href="#"
                                                                            ...
                                                                            Products</a></li>
                                                                    <li class="item "><a href="#"
                                                                            title="Mionix Products">Mionix Products</a>
                                                                    </li>
                                                                    <li class="item "><a href="#"
                                                                    ...
                                                                    <li class="item "><a href="#"
                                                                            ...
                                                                            LoudSpeaker</a></li>
                                                                    <li class="item "><a href="#"
                                                                            title="Tangent Audio">Tangent Audio</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                            <div class="col-lg-3 col-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-3 col-12">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li class="item  parent"><a href="#"
                                                                            title="iPhone 7 / 7 Plus">iPhone 7 / 7
                                                                            Plus</a></li>
                                                                    <li class="item "><a href="#"
                                                                            title="iPhone 6s / 6s Plus">iPhone 6s / 6s
                                                                            Plus</a></li>
                                                                    <li class="item "><a href="#"
                                                                            title="Accesories">Accesories</a></li>
                                                                </ul>
                                                            ...
                                                            <div class="col-lg-3 col-12">
                                                                ...
                                                                <ul>
                                                                    <li class="item "><a href="#"
                                                                            title="SamSung Galaxy">SamSung Galaxy</a>
                                                                    </li>
                                                                    <li class="item  parent"><a href="#"
                                                                            title="Samsung ">Samsung </a></li>
                                                                    <li class="item "><a href="#"
                                                                    ...
                                                                    <li class="item "><a href="#"
                                                                            title="Motorola ">Motorola</a></li>
                                                                    <li class="item "><a href="#"
                                                                            title="Asus (Zenfone)">Asus (Zenfone)</a>
                                                                    </li>
                                                                    <li class="item "><a href="#"
                                                                            title="HTC">HTC</a></li>
                                                                    <li class="item "><a href="#"
                                    ...
                                    <li class="item "><a href="#" title="Smart Watches "><i
                                            ...
                                            Watches </a><span class="menu-sub-title">Lorem ipsum dolor sit amet
                                            quam</span></li>
                                    ...
                                    <li class="item "><a href="#" title="Monitor &amp; Television"><i
                                            ...
                                            &amp; Television</a><span class="menu-sub-title">Sony BRAVIA, SamSung, TV
                                            4K ...</span></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div id="megamenu" class="nov-megamenu clearfix">
                                <ul class="menu level1">
                                    <li class="item home-page has-sub"><span class="opener"></span><a href="?home"
                                            title="Home"><i class="zmdi zmdi-home"></i>Home</a>
                                                            ...
                                                            <li class="item col-lg-3 col-md-3 html"><span
                                                                ...
                                                                <div class="menu-content">
                                                                    <ul class="col">
                                                                        ...
                                                                        <li><a href="#"
                                                                                title="Lenovo Yoga">Lenovo Yoga</a>
                                                                        </li>
                                                                        <li><a href="#"
                                        ...
                                        <div class="input-group-btn nov_category_tree hidden-sm-down">
                                            ...
                                            <ul class="dropdown-menu list-unstyled">
                                                <li class="dropdown-item active" data-value="0"><span>All
                                                        Categories</span></li>
                                                <li class="dropdown-item " data-value="2"><span>الصفحة الرئيسية</span>
                                                </li>
